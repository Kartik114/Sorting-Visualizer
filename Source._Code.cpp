...
void inplaceHeapSort(int* input, int n)
{
    for (int i = 1; i < n; i++)
    {
        ...
        while (childIndex > 0)
        {
            ...
            SDL_Delay(100);
            bool p = PlaySound(TEXT("sound.wav"), NULL, SND_ASYNC);
    ...
    for (int idx = n - 1; idx >= 0; idx--)
    {
        ...
        while (leftChildIndex < idx)
        {
            ...
            input[mx] = temp;
            SDL_Delay(100);
            bool p = PlaySound(TEXT("sound8.wav"), NULL, SND_ASYNC);
...
int partition_array(int a[], int si, int ei)
{
    ...
    while (i<c && j>c)
    {
        ...
        else
        {
            ...
            a[i] = temp_1;
            SDL_Delay(50);
            bool p = PlaySound(TEXT("sound4.wav"), NULL, SND_ASYNC);
            visualize(i, j);
            SDL_Delay(70);
    ...
    for (int i = 0; i < arrSize; i++)
    {
        ...
        for (int j = i + 1; j < arrSize; j++)
        {
            if (arr[j] < mn)
            {
                ...
                bool p = PlaySound(TEXT("sound5.wav"), NULL, SND_ASYNC);
                SDL_Delay(100);
            }
